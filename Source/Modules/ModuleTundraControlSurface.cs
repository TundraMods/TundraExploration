...
namespace TundraExploration
{
    public class ModuleTundraControlSurface : ModuleLiftingSurface, IMultipleDragCube, ITorqueProvider
    {
        /*
         * Definition:
           - X, right
        ...
        public const string MODULENAME = "ModuleTundraControlSurface";
